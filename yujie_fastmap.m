...
function ST08_1_fastmap(Afname,Xpixel,Ypixel,bin,resolution)
%% Load data
%clc
close all;
%%
...
%xlable('X in um');
%ylabel('Y in um');
figurefilename1 = strcat(Afname(1:end-4),'-Bin',num2str(bin),'-Res',num2str(resolution),'-Rend.fig'); 
figurefilename2 = strcat(Afname(1:end-4),'-Bin',num2str(bin),'-Res',num2str(resolution),'-Rend.png'); 
saveas(gcf,figurefilename1,'fig');
saveas(gcf,figurefilename2,'png');
tiffilename = strcat(Afname(1:end-4),'-Bin',num2str(bin),'-Res',num2str(resolution),'-Rend.tif');
